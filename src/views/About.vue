    ...
    <section class="py-20 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div class="bg-white p-10 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            <h3 class="text-xl font-bold text-primary mb-4">Nossa Missão</h3>
            <p class="text-gray-600">Fornecer soluções periciais com excelência técnica, clareza e imparcialidade, contribuindo para a justa resolução de conflitos.</p>
          </div>
          <div class="bg-white p-10 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            <h3 class="text-xl font-bold text-primary mb-4">Nossa Visão</h3>
            <p class="text-gray-600">Ser referência nacional em perícia judicial e extrajudicial, reconhecida pela qualidade técnica e credibilidade de nossos laudos.</p>
          </div>
          <div class="bg-white p-10 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            <h3 class="text-xl font-bold text-primary mb-4">Nossos Valores</h3>
         ...
         <div class="mt-16 text-center max-w-3xl mx-auto">
             <h3 class="text-2xl font-serif font-bold text-primary mb-4">Nosso Propósito</h3>
             <p class="text-gray-600 text-lg">Iluminar a verdade dos fatos através da ciência pericial, garantindo segurança jurídica e técnica para nossos clientes e parceiros.</p>
         </div>
